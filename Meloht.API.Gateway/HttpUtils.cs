...
namespace Meloht.API.Gateway
{
    internal static class HttpUtils
    {
        ...
        public static HttpRequestModel GetRequestDataModel(HttpRequest request, string targetUrl)
        {
            ...
            model.TargetUrl = GetTargetUrl(request, targetUrl);
            ...
            if (request.HasFormContentType && request.Form != null)
            {
                ...
                {
                    model.FormValues.Add(item.Key, [.. item.Value]);
                }
            }
            if (request.Query != null && request.Query.Count > 0)
            {
                ...
                {
                    model.QueryStringValues.Add(item.Key, [.. item.Value]);
                }
            }
        ...
        public static string GetTargetUrl(HttpRequest request, string targetUrl)
        {
            string http = "http";
            if (request.IsHttps)
            {
